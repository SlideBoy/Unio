<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="propostasRecebidas.aspx.cs" Inherits="Unio.propostasRecebidas" %>
...
<body>
    ...
    <article class="popupDetalhes escondido">
        <div class="areaVermelha">Você realmente deseja aceitar esta proposta?</div>
        ...
        <main>
            <section class="geral">
                ...
                <section class="resultadosBusca">
                    <div class="divBuscar">
                        <input id="iptBusca" type="text" placeholder="Busque por...">
                        <a href="" class="btnBuscar">
                            <button id="btnBuscar">
                                <img src="imagens/icones/lupa_azul.png" alt="">
                            </button>
                        </a>
                    </div>
                    ...
                    <div class="resultados">
                        ...
                        <article class="anuncio">
                            <div class="titulo_Btn">
                                <h2>Conserto de geladeira</h2>
                                <button class="btnVerDetalhes">Ver detalhes</button>
                            </div>
